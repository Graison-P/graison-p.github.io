...
3. **Issue Creation**: Creates a GitHub issue with:
   - Commit information (SHA, message, author, date)
   - Screenshots of all pages embedded as base64 images
...
1. Check the "Issues" tab for a new issue titled "📸 Website Screenshots - YYYY-MM-DD"
2. The issue contains embedded screenshots of all pages
3. Screenshots are also available as workflow artifacts in the Actions tab
